...
public class LCFunctionCheckManager {
	...
	private static final int GET_USER_INFO_CALLBACK = 1;
	 ...
	 * @param item
	 */
	public void onGetUserInfo(LiveChatErrType errType, String userId, LiveChatTalkUserListItem item){
		boolean isSuccess = false;
		Message msg = Message.obtain();
		msg.what = GET_USER_INFO_CALLBACK;
