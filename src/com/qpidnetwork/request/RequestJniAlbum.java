...
public class RequestJniAlbum {
	...
	public enum ReviewReason {
		REASON_OTHERS,//其他
		REASON_NON_SELF,//照片中未出現女士本人
		REASON_SIMILAR_VIDEOSHOW,//视频与videoshow相似
		REASON_FACIAL_BLUR,//视频中女士容貌模糊/失真
		REASON_VIDEO_UPSIDE_DOWN,//视频倒置/无法显示
		REASON_APPEARANCE_NOT_MATCH,//视频中女士衣着/仪态不符合要求
		REASON_FACE_PHOTO_NOMATCH,//视频中女士容貌/身材与资料照片差异过大
		REASON_EXIST_SIMILAR_SHORTVIDEO,//女士已上传内容相似的微视频
		REASON_VIDEO_TOO_SHORT,//视频时长不足8秒
		REASON_REVISED_DESC_NOSTANDARD,//描述不規範
		REASON_REVISED_COVER_NOSTANDARD,//封面不規範
		REASON_REVISED_COVERANDDESC_NOSTANDARD //封面及描述均不規範
	}
