...
public class MaterialDropDownMenu {
	...
	public void showAsDropDownAtVerticalCenter(View anchor){
		int offset = (int)((DeviceUtil.getScreenSize().x - mPopupWindow.getWidth()) / 2.0f);
		mPopupWindow.showAsDropDown(anchor, offset, (int)(-42.0f * mContext.getResources().getDisplayMetrics().density));
	}
