 ...
 */
public class HeaderableGridView extends GridView{
    ...
    public HeaderableGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderGridView();
    }

    public HeaderableGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            int realLeft = HeaderableGridView.this.getPaddingLeft() + getPaddingLeft();
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = HeaderableGridView.this.getMeasuredWidth()
                    - HeaderableGridView.this.getPaddingLeft()
                    - HeaderableGridView.this.getPaddingRight();
